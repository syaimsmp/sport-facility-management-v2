					...
					<table class="table">
						...
						<tbody>
							<tr class="text-center">
								...
								<td class="mid-align"><%=facility.getStatus()%></td>
		
								<td class="mid-align"><a
									href="updateFacility?facilityId=<%=facility.getId()%>"><button
											type="button" class="btn btn-primary">Update Details</button></a> <a
									href="updateFacilityStatus?facilityId=<%=facility.getId()%>"><button
											type="button" class="btn btn-primary">Update Status</button></a> <a
									href="viewfacilityreviews?facilityId=<%=facility.getId()%>"><button
